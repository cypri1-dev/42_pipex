...
#    Updated: 2024/04/25 15:49:13 by cyferrei         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
MAIN = pipex.c pipex_utils.c children_cmd.c error.c
MAIN_BONUS = pipex_bonus.c pipex_utils_bonus.c children_process.c children_process_utils.c checks.c
